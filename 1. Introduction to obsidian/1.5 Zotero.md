...
# Exercise 1.5
1. Download and prepare all add-ons on Zotero and the Citations plugins on obsidian. Be sure to select the path of your .bib file in the vault in your plugin.
