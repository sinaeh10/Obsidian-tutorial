...
12. Pandoc plugin <- this plugin lets you convert your documents to Word format direction from Obsidian. The plugin is still under development, unfortunately, so a bibliography cannot yet be generated (Daniel and I have a work-around for this, using Zettlr. For more on this, head over to [[1.6 Pandoc and Zettlr]]). However, I am confident that in a few months, this feature will also be available.
